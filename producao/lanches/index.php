...
<style>
    ...
    *::-webkit-scrollbar-thumb {
        ...
        <div class="painel">
            <h4 style="position:fixed; top:0; height:40px; z-index:10; width:100%; padding-left:15px; padding-top:5px; background-color:#fff">Dados da cozenha (Produção de LANCHES)</h4>
