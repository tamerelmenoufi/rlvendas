<?php
    ...
    $query = "select a.*, b.mesa as mesa from vendas_produtos a left join mesas b on a.mesa = b.codigo where a.codigo IN ({$cod}) and JSON_EXTRACT(produto_json, '$.categoria.codigo') in ({$Categoria})";
