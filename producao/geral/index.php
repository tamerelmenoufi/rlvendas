...
<style>
    ...
    *::-webkit-scrollbar-thumb {
        ...
        <?php
            echo $query = "select a.*, b.mesa as mesa, c.alertas from vendas_produtos a left join mesas b on a.mesa = b.codigo left join vendas c on a.venda = c.codigo where a.situacao in('p','i') and a.deletado != '1' and JSON_EXTRACT(produto_json, '$.categoria.codigo') in ({$Categoria}) order by a.ordem asc";
