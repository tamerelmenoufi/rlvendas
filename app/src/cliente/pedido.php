...
<div class="col" style="margin-bottom:60px; margin-top:20px;">
    <div class="col-12">
        ...
        <div class="card bg-light mb-3" style="padding-bottom:40px;">
            <div class="card-body">
                <p Excluirproduto style="position:absolute; right:-10px; top:-10px; width:auto;">
                    <i codigo="<?=$d->codigo?>" produto="<?=$pedido->categoria->descricao?> - <?=$pedido->medida->descricao?> <?=$sabores?>" class="fa-solid fa-circle-xmark" style="color:orange; font-size:30px;"></i>
                <p>
