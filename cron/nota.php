...
$query = "SELECT * FROM `vendas` where /*codigo in (select codigo from vendas_pagamento where data_pedido >= '2024-07-17 00:00:00' and forma_pagamento = 'credito') and*/ deletado != '1' and situacao = 'pago' and nf_status = '' limit 1";
