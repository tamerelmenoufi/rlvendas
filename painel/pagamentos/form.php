...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($codigo) {
        $query = "UPDATE pagamentos SET {$attr} WHERE codigo = '{$codigo}'";
    } else {
    ...
    if (mysqli_query($con, $query)) {
        ...
        sis_logs('pagamentos', $codigo, $query);
...
if ($codigo) {
    $query = "SELECT * FROM pagamentos WHERE codigo = '{$codigo}'";
    ...
    <div class="card-body">
        <form id="form-<?=$md5?>">
            <div class="form-group">
                <label for="categoria">pagamento <i class="text-danger">*</i></label>
                <input
                        type="text"
                        class="form-control"
                        id="pagamento"
