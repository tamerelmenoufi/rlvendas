...
<div class="row">
    <div class="col">
        ...
        echo $q = "select sum(a.total) as total, forma_pagamento from vendas a left join vendas_pagamentos b on a.codigo = b.venda where (a.data_finalizacao between '{$ini}' and '{$fim}') and a.situacao = 'pago' group by total, b.forma_pagamento";
