...
<div class="row">
    <div class="col">
        ...
        $q = "select sum(a.total) as total, b.forma_pagamento from vendas a left join vendas_pagamento b on a.codigo = b.venda and b.deletado != '1' where (a.data_finalizacao between '{$ini}' and '{$fim}') and a.situacao = 'pago' group by b.forma_pagamento order by tatal desc";
