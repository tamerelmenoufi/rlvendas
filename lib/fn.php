...
function VerificarVendaApp($app = 'garcom'){
    ...
    echo "SELECT * FROM vendas WHERE app = '{$app}' and cliente = '{$_SESSION['AppCliente']}' AND mesa = '{$_SESSION['AppPedido']}' AND situacao not in ('pago','pagar') AND deletado != '1' LIMIT 1";
