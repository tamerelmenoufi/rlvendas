	...
	// CONFIGURA AS FORMAS DE PAGAMENTO ATUAL DO SEU SISTEMA
		...
		$data_nfe = array(
			...
			'pedido' => array(
				...
				'desconto' =>  number_format($rowVenda["desconto"]*0, 2, '.', ''),  // Total do desconto
				'outras_despesas' =>  number_format($rowVenda["taxa"]*0, 2, '.', ''), // Outras Despesas
				'total' =>  number_format(($rowVenda["valor"] + $rowVenda["taxa"] - $rowVenda["desconto"]), 2, '.', ''), // Valor total do pedido pago pelo cliente
				'troco' =>  number_format(0, 2, '.', ''), // Troco
				'forma_pagamento' =>  $formasPagamentoNF[(($rowVenda["forma_pagamento"])?:'dinheiro')], // 01 - dinheiro // 02-
