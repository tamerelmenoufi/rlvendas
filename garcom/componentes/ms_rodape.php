...
<div class="row">
    <div class="col acao" componente="ms_popup_100" local="src/mesas/home.php"><i class="fa-solid fa-circle-user"></i><p>Mesas <?=$_SESSION['AppCliente']?></p></div>
    <div class="col acao" componente="ms_popup_100" local="src/produtos/pedido.php"><i class="fa-solid fa-bell-concierge"></i><p>Pedido <?=$m->mesa?></p></div>
